...
#ifndef ARBITER_GS_PRIORITY_DEFLECTION_HELPER
#define ARBITER_GS_PRIORITY_DEFLECTION_HELPER

#include "ns3/arbiter-gs-priority-deflection.h"
...
namespace ns3 {
    ...
    class ArbiterGSPriorityDeflectionHelper
    {
    public:
    ...
    private:
        ...
        std::vector<Ptr<ArbiterGSPriorityDeflection>> m_arbiters;
    };

} // namespace ns3

#endif /* ARBITER_GS_PRIORITY_DEFLECTION_HELPER */
