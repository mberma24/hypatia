...
NS_OBJECT_ENSURE_REGISTERED (ArbuterGSPriorityDeflection);
TypeId ArbuterGSPriorityDeflection::GetTypeId (void)
{
    static TypeId tid = TypeId ("ns3::ArbuterGSPriorityDeflection")
...
ArbuterGSPriorityDeflection::ArbuterGSPriorityDeflection(
        Ptr<Node> this_node,
        NodeContainer nodes,
...
// std::tuple<int32_t, int32_t, int32_t> ArbuterGSPriorityDeflection::TopologySatelliteNetworkDecide(
//         int32_t source_node_id,
//         int32_t target_node_id,
//         Ptr<const Packet> pkt,
//         Ipv4Header const &ipHeader,
...
// void ArbuterGSPriorityDeflection::SetDeflectionState(int32_t target_node_id, int32_t next_node_id, int32_t own_if_id, int32_t next_if_id) {
...
void ArbuterGSPriorityDeflection::SetDeflectionState(int32_t target_node_id, const std::vector<std::tuple<int32_t, int32_t, int32_t>>& next_hops) {
...
std::string ArbuterGSPriorityDeflection::StringReprOfForwardingState() {
